        ...
        {active === 0 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">FORMATION SCOLAIRE</div>
            ...
            <div className="resume-detail-bottom">
              <div className="resume-detail-bottom-title">Détail</div>
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- Diplôme du BIA obtenu en Seconde au lycée Jules Ferry</div>
                <div className="resume-detail-bullet">- BAC STI2D Mention Bien obtenu à Emilie de Breteuil</div>
              </div>
            </div>
          </div>
        )}
        ...
        {active === 1 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">Mes compétences Informatique</div>
            ...
            <div className="resume-detail-list">
              <div className="resume-detail-row">
                ...
                <div className="resume-detail-row-title">Interfaces Web: HTML CSS</div>
                <div className="resume-detail-status">Maîtrisé</div>
              </div>
              <div className="resume-detail-row">
                <div className="resume-detail-row-index">02</div>
                <div className="resume-detail-row-title">Langue: Allemand et Anglais</div>
                <div className="resume-detail-status">Maîtrisé</div>
              </div>

              <div className="resume-detail-row">
                <div className="resume-detail-row-index">03</div>
                <div className="resume-detail-row-title">Dev: C/C++, Java, Python</div>
                <div className="resume-detail-status">En cours</div>
              </div>

              <div className="resume-detail-row">
                <div className="resume-detail-row-index">04</div>
                <div className="resume-detail-row-title">Base de Donnée: SQLite, MySQL</div>
                <div className="resume-detail-status">En cours</div>
              </div>
            </div>
            ...
            <div className="resume-detail-bottom">
              <div className="resume-detail-bottom-title">Détail</div>
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- Niveau A2 en allemand et B2-C1 en anglais</div>
              </div>
            </div>
          </div>
        )}
        ...
        {active === 2 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">Mes qualités</div>
              <div className="resume-detail-top-progress">4/5</div>
            </div>
            ...
            <div className="resume-detail-list">
              <div className="resume-detail-row">
                <div className="resume-detail-row-index">01</div>
                <div className="resume-detail-row-title">Autonomie</div>
              </div>
              <div className="resume-detail-row">
                <div className="resume-detail-row-index">02</div>
                <div className="resume-detail-row-title">Organisé en projet</div>
              </div>

              <div className="resume-detail-row">
                <div className="resume-detail-row-index">03</div>
                <div className="resume-detail-row-title">Curieux</div>
              </div>

              <div className="resume-detail-row">
                <div className="resume-detail-row-index">04</div>
                <div className="resume-detail-row-title">Ponctuelle sur son travail</div>
              </div>
            </div>

            <div className="resume-detail-bottom">
              <div className="resume-detail-bottom-title">Détail supplémentaire</div>
              <div className="resume-detail-bullets">
        ...
        {active === 3 && (
          <div className="resume-detail-panel">
            <div className="resume-detail-top">
              ...
              <div className="resume-detail-top-title">Logiciel Utilisés</div>
              <div className="resume-detail-top-progress">4/5</div>
            </div>
            ...
            <div className="resume-detail-list">
              <div className="resume-detail-row">
                <div className="resume-detail-row-index">01</div>
                <div className="resume-detail-row-title">VS Code (programmation)</div>
                <img src={vscodeIcon} style={{ height: "36px", width: "auto", objectFit: "contain", marginRight: "10px", clipPath: "polygon(0 0, 100% 0, calc(100% - 8px) 100%, 0 100%)" }} />
              </div>
              <div className="resume-detail-row">
                <div className="resume-detail-row-index">02</div>
                <div className="resume-detail-row-title">sqldevelopper (base de donnée)</div>
                <img src={mySqlIcon} style={{ height: "36px", width: "auto", objectFit: "contain", marginRight: "10px", clipPath: "polygon(0 0, 100% 0, calc(100% - 8px) 100%, 0 100%)" }} />
              </div>

              <div className="resume-detail-row">
                <div className="resume-detail-row-index">03</div>
                <div className="resume-detail-row-title">Gitbash (gestion de projet)</div>
                <img src={gitIcon} style={{ height: "36px", width: "auto", objectFit: "contain", marginRight: "10px", clipPath: "polygon(0 0, 100% 0, calc(100% - 8px) 100%, 0 100%)" }} />
              </div>

              <div className="resume-detail-row">
                <div className="resume-detail-row-index">04</div>
                <div className="resume-detail-row-title">Blender (modélisation 3D)</div>
                <img src={blenderIcon} style={{ height: "36px", width: "auto", objectFit: "contain", marginRight: "10px", clipPath: "polygon(0 0, 100% 0, calc(100% - 8px) 100%, 0 100%)" }} />
              </div>
            </div>
